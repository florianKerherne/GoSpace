    ...
    chargeVoyage(idVoyage){
      AXIOS.get(`voyage/`+idVoyage)
        .then(response => {
          ...
          this.DestinationDescription  = response.data.idLieuDestination.description;
          ...
          if(response.data.promotion>0){
            ...
            this.prixFinal = response.data.prix - response.data.prix * response.data.promotion/100;
          }else{
          ...
          this.DateDepart  = varDateDepart.getDay()+"/"+varDateDepart.getMonth()+"/"+varDateDepart.getFullYear();
          this.DateArrive  = varDateArrive.getDay()+"/"+varDateArrive.getMonth()+"/"+varDateArrive.getFullYear();
